...
public class JugadorCampo extends Futbolista{
	...
	public void tirarAPorteria(String resultado){
		System.out.println("El jugador " + this.getNombre() + "tira a porteria y... " + resultado);
	}
	public void celebrarGol(String equipo){
		System.out.println("!Goool de " + equipo + "! los futbolistas celebran el gol");
	}
}
