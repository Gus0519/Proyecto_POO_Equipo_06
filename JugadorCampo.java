...
public class JugadorCampo extends Futbolista{
	...
	public JugadorCampo(String nombre, String nacionalidad, Fecha fechaNacimiento, int numero, String valorActual, String perfil, String posicion,String equipo, int fuerzaTiro, int precisionPases, int estadoFisico ) {
	...
	public String tirarAPorteria(String resultado){
		return "El jugador " + this.getNombre() + "tira a porteria y... " + resultado;
	}
	public String celebrarGol(String equipo){
		return "!Goool de " + equipo + "! los futbolistas celebran el gol";
	}
	public String toString(){
		return super.toString() + "\nPosicion: " + this.posicion +
		"\nFuerza de tiro: " + this.fuerzaTiro + 
		"\nPrecision de pases: " + this.precisionPases + "\nEstado fisico: " + this.estadoFisico;
	}
}
